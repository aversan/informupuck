...
/******/ 	var hotCurrentHash = "c6dc3ce397e0772cc3d1"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';var _typeof2=__webpack_require__(37);var _typeof3=_interopRequireDefault(_typeof2);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/**
	 * Swiper 3.3.1
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (addon) {
	    ...
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(83)], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	* Copyright (c) 2015 James Florentino; Licensed MIT */
	(function (factory) {
	  if (true) {
	    return !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(89)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($) {
	...
	$(function () {
	  ...
	  function checkboxChanged() {
	    ...
	    container.find('input[type="checkbox"]').prop({
	      indeterminate: false,
	      checked: checked
	    }).siblings('label').removeClass('custom-checked custom-unchecked custom-indeterminate').addClass(checked ? 'custom-checked' : 'custom-unchecked');
	  ...
	  function checkSiblings($el, checked) {
	    ...
	    if (all && checked) {
	      parent.find('> div > p > input[type="checkbox"]').prop({
	        indeterminate: false,
	        checked: checked
	      }).siblings('label').removeClass('custom-checked custom-unchecked custom-indeterminate').addClass(checked ? 'custom-checked' : 'custom-unchecked');
	      ...
	      parent.find('> div > p > input[type="checkbox"]').prop("checked", checked).prop("indeterminate", indeterminate).siblings('label').removeClass('custom-checked custom-unchecked custom-indeterminate').addClass(indeterminate ? 'custom-indeterminate' : checked ? 'custom-checked' : 'custom-unchecked');
	
	      checkSiblings(parent, checked);
	    } else {
	      $el.parents("li").find('> div > p > input[type="checkbox"]').prop({
	        indeterminate: true,
	        checked: false
